...
# you’ll see HTML (the language in which web pages are written)like the below, which you could then
# copy into your own website’s source code, wherein iframe is an HTML “element,” and src is
# one of several HTML “attributes” therein, the value of which, between quotes, is https://www.youtube.com/embed/xvFZjo5PgG0.
...
# Suppose that you’d like to extract the URLs of YouTube videos that are embedded in
# pages (e.g., https://www.youtube.com/embed/xvFZjo5PgG0), converting them back to shorter,
