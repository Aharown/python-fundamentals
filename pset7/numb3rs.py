...
# Structure numb3rs.py as follows, wherein you’re welcome to modify main and/or implement other functions as you see
...
# in a file called test_numb3rs.py, two or more functions that collectively test your implementation of validate
# thoroughly, each of whose names should begin with test_ so that you can execute your tests with:

# pytest test_numb3rs.py

# pseudocode
# for validate function assign match var with match object returned when using fullmatch
# if a match object is returned validate the groups ensuring all digits are between 0 and 255

# Time: O(n) fullmatch scans input str scales with size of input
